...
import com.example.demo.exceptions.ParseXMLException;
import com.example.demo.exceptions.UnknownCharCodeException;
...
public class ClientXML implements Client {
    ...
    @Override
    public Rate getRate(String code, Date date)
            throws ExchangeRateApplicationException {
        try {
    ...
    private BigDecimal getDailyRateValue(String code, Date date)
            throws IOException,
            ParseXMLException,
            UnknownCharCodeException,
            NoDataFoundException {
        DateFormat sdf = new SimpleDateFormat(CBR_DATE_FORMAT);
        String dateParameter = sdf.format(date);
        String requestUrl = String.format(XML_DAILY_URL,
                dateParameter);
    ...
    private BigDecimal parseResponseString(String code,
                                           Reader xmlReader)
        ...
        try {
            ...
            throw new ParseXMLException(ex);
        }
    }
}